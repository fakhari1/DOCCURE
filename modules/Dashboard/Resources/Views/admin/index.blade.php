...
<img class="avatar-img rounded-circle" alt="User Image" src="dashboard_files/doctor-thumb-01.jpg">
                                            ...
                                            <div class="media-body flex-grow-1">
                                                <p class="noti-details"><span class="noti-title">پزشک. رابی پرین</span>
                                                    زمانبندی <span class="noti-title">نوبت ها</span></p>
                                                <p class="noti-time"><span class="notification-time">4 دقیقه قبل</span>
                                                </p>
                                            </div>
                                        </div>
                                    </a>
...
<img class="avatar-img rounded-circle" alt="User Image" src="dashboard_files/patient1.jpg">
                                            ...
                                            <div class="media-body flex-grow-1">
                                                <p class="noti-details"><span class="noti-title">مگان برد</span> نوبت
                                                    گرفته است از <span class="noti-title">پزشک. رابی پرین</span></p>
                                                <p class="noti-time"><span class="notification-time">6 دقیقه قبل</span>
                                                </p>
                                            </div>
                                        </div>
                                    </a>
...
<img class="avatar-img rounded-circle" alt="User Image" src="dashboard_files/patient2.jpg">
                                            ...
                                            <div class="media-body flex-grow-1">
                                                <p class="noti-details"><span class="noti-title">الوین بویکین</span>
                                                    مبلغ 210 تومان پرداخت کرد <span class="noti-title">نوبت</span></p>
                                                <p class="noti-time"><span class="notification-time">8 دقیقه قبل</span>
                                                </p>
                                            </div>
                                        </div>
                                    </a>
...
<img class="avatar-img rounded-circle" alt="User Image" src="dashboard_files/patient3.jpg">
                                            ...
                                            <div class="media-body flex-grow-1">
                                                <p class="noti-details"><span class="noti-title">نیکلاس هیج</span> یک
                                                    پیام ارسال کرد <span class="noti-title">به پزشک خود</span></p>
                                                <p class="noti-time"><span class="notification-time">12 دقیقه قبل</span>
                                                </p>
                                            </div>
                                        </div>
                                    </a>
                ...
                <li class="nav-item dropdown has-arrow">
                    <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                        <span class="user-img"><img class="rounded-circle" src="{{ asset('assets/images/avatar-01.jpg') }}"
                                                    width="31" alt="Donald Niles"></span>
                    </a>
                    <div class="dropdown-menu">
                        <div class="user-header">
                            <div class="avatar avatar-sm">
                                <img src="{{ asset('assets/images/avatar-01.jpg') }}" alt="User Image"
                        ...
                        <a class="dropdown-item"
                           href="https://atiyehahmadi.ir/doccure/pediatric-rtl/admin/profile.html">پروفایل من</a>
                        <a class="dropdown-item"
                           href="https://atiyehahmadi.ir/doccure/pediatric-rtl/admin/settings.html">تنظیمات</a>
